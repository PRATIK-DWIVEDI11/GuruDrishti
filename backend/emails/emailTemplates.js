export function createWelcomeEmailTemplate(name, profileUrl) {
  ...
  <head>
    ...
    <title>Welcome to GuruDrishti</title>
  </head>
  <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(to right, red, orange); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
      <img src="https://i.postimg.cc/mk1zYwxW/Guru-Drishti-Logo.png" alt="GuruDrishti Logo" style="width: 150px; margin-bottom: 20px;border-radius: 10px;">
      <h1 style="color: white; margin: 0; font-size: 28px;">Welcome to GuruDrishti!</h1>
    </div>
    <div style="background-color: #ffffff; padding: 30px; border-radius: 0 0 10px 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
      <p style="font-size: 18px; color: #0077B5;"><strong>Hello ${name},</strong></p>
      <p>We're thrilled to have you join our GuruDrishti community! GuruDrishti is your platform to connect, learn, and grow in your career by the method of self-appraisal.</p>
      <div style="background-color: #f3f6f8; padding: 20px; border-radius: 8px; margin: 20px 0;">
        ...
        <ul style="padding-left: 20px;">
          ...
          <li>Connect with other faculties</li>
        </ul>
      </div>
      ...
      <p>Best regards,<br>The GuruDrishti Team</p>
    </div>
  </body>
  </html>
  `;
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: #ffffff; padding: 30px; border-radius: 0 0 10px 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
    ...
    <p>Great news! <strong>${recipientName}</strong> has accepted your connection request on GuruDrishti.</p>
    <div style="background-color: #f3f6f8; padding: 20px; border-radius: 8px; margin: 20px 0;">
      <p style="font-size: 16px; margin: 0;"><strong>What's next?</strong></p>
      <ul style="padding-left: 20px;">
        <li>Check out ${recipientName}'s full profile</li>
        <li>Connect with ${recipientName}</li>
      </ul>
    </div>
    <div style="text-align: center; margin: 30px 0;">
    ...
    <p>Expanding your professional network opens up new opportunities!</p>
    <p>Best regards,<br>The GuruDrishti Team</p>
  </div>
</body>
</html>
